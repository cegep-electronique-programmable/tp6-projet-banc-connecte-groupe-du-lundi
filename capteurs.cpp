...
const int16_t I2C_MASTER = 0x42; //exemple ne sais pas si vrai
const int16_t I2C_SLAVE = 0x39; // L'adresse du capteur
...
void capteurRead() {
  ...
  if (nextPing) {
    Wire.requestFrom(I2C_SLAVE, 6);  // request 6 bytes from slave device #39
